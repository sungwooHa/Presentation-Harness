...
# Or from reference/
cp reference/onsite_team_meeting.png "$OUT/assets/images/team-meeting.png"
```
...
Chart type guide (see `data-visualization-guide` skill):
...
### 5. Fonts
Already bundled in `assets/fonts/` (Paperlogy 8 weights). For additional fonts:
...
| S5 | reference/onsite_summary.png | assets/images/s05-summary.png | Inline |
| S15 | (self-generated SVG) | inline | 3-mirror diagram |
