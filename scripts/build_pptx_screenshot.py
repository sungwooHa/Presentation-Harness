...
사용법
  python scripts/build_pptx_screenshot.py output/거울을_마주보다/index.html
    → output/거울을_마주보다/index.pptx 생성
...
def main() -> int:
    ...
    ap.add_argument("html", help="메인 덱 HTML 경로 (예: output/거울을_마주보다/index.html)")
